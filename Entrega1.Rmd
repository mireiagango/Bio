...
introdució rna.seq ORGANISME: MUS MUSCULUS M.BIOLOGIC: mRNA
L'objectiu és buscar gens que s'expressen (expresio) diferencial entre condicions
...
dim(genes)
```
Observem que hi ha 2 observacions menys, per tant hi havia dos repetits
